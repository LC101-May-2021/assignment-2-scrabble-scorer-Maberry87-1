...
function scorerPrompt(word) {
	let scoreType = input.question(
		'Which scoring algorithm would you like to use? 0 - Simple: One point per character 1 - Vowel Bonus: Vowels are worth 3 points 2 - Scrabble: Uses scrabble point system Enter 0, 1, or 2: '
	);
